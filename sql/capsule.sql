...
*/
INSERT INTO capsule ('capsule_name','description','duration_video','id_poi','id_user','url_video')
VALUES
    ('Les Fusillés de Vauban', 'Avec BinocleTV, partez à la découverte de Lille. Aujourd''hui
, découvrez la statue des Fusillés, devant l''esplanade.', '84', '1', '3', 'https://www.youtube.com/watch?v=YNdpZG97MYw&list=PLpmketXDUgwEWeA4bfue83eYQmbdc7lJX'),
    ('La place du théâtre à Lille', 'Visualisé la place du théâtre', '35', '2', '3', 'https://www.youtube.com/watch?v=iz0RL4Bf65w'),
    ('Visite HD chez De Gaulle', "Découvrez l'intérieur de la maison natale du Général De Gaulle !", '376', '3', '1', 'https://youtu.be/hRVPkVNRa0E'  ),
